...
def _create_arch(config):
    ...
    elif config.arch_name == "KAN":
        arch = archs.KAN(**config)

    elif config.arch_name == "ChebyKAN":
        arch = archs.ChebyKAN(**config)
    ...
    elif config.arch_name == "SincKAN":
        arch = archs.SincKAN(**config)

    elif config.arch_name == "ModifiedSincKAN":
        arch = archs.ModifiedSincKAN(**config)

    elif config.arch_name == "ModifiedSincKANOriginal":
        arch = archs.ModifiedSincKANOriginal(**config)
