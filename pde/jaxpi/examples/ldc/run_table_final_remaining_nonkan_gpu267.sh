...
(
  run_one 6 table_final_modifiedmlp_seed123
  run_one 6 table_final_modifiedmlp_seed2026
  run_one 6 table_final_ours_seed123
) &

(
  run_one 7 table_final_sinckan_seed123
  run_one 7 table_final_sinckan_seed2026
  run_one 7 table_final_ours_seed2026
) &

wait
echo "[$(date '+%F %T')] table final remaining non-KAN seed runs finished"
