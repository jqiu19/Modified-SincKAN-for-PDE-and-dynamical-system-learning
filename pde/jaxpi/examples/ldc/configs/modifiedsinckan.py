...
def get_config():
    """Get the ModifiedSincKAN LDC hyperparameter configuration."""
    ...
    swanlab.project = "PINN-LDC-modifiedsinckan"
    swanlab.name = "modifiedsinckan"
    swanlab.tag = None
    ...
    arch.arch_name = "ModifiedSincKAN"
    arch.num_layers = 4
    arch.degree = 8
    arch.u_degree = 8
    arch.v_degree = 8
