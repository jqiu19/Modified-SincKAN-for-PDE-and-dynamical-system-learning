...
parser.add_argument("--wandb_group", type=str, default='approximation_1d', help="wandb group name")
...
def train (key):
    ...
    wandb_run = init_wandb_run(args, "approximation_1d", extra_config={"input_dim": input_dim, "output_dim": output_dim})
    # Hyperparameters
    N_train = args.ntrain
    ...
    header = [
        ...
        "train_mse", "train_rmse", "train_relative", "test_mse", "test_rmse", "test_relative"
    ]
